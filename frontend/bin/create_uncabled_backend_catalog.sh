...
stream_xml_dir="${OOI_ERDDAP_DATA_HOME}/erddap-11-2/stream-xml";

# Location of ERDDAP datasets.xml file
datasets_xml_file='/var/local/erddap/content/content-11-2/erddap/datasets.xml';

# Usage message
USAGE="
NAME
    $app - Write the ERDDAP datasets.xml file containing individual OOI stream datasets
    to the backend uncabled ERDDAP server
...
tmp_datasets_xml_file='/var/local/erddap/content/content-11-2/erddap/datasets.xml.tmp';
if [ -z "$debug" ]
then

...
stream_xml_dir="${OOI_ERDDAP_DATA_HOME}/erddap-12-2/stream-xml";

# Location of ERDDAP datasets.xml file
datasets_xml_file='/var/local/erddap/content/content-12-2/erddap/datasets.xml';
...
tmp_datasets_xml_file='/var/local/erddap/content/content-12-1/erddap/datasets.xml.tmp';
if [ -z "$debug" ]
then
